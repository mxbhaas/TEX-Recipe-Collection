...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item Toss wings with sauce to coat. Serve immediately with blue cheese dressing and celery.
	\end{enumerate}	
\end{minipage}
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item Add pumpkin and apples to a pot. Squeeze the lemon and add juice, apple juice, and a pinch of salt.
		\item Scrape the vanilla bean seeds and add both seeds and pod to the pot. Cover and cook for approximately 20min until pumpkin is soft.
		\item Remove vanilla pod and purée finely with an immersion blender.
		\item Add gelling sugar and cinnamon, stir well and cook according to package instructions (approximately 3min).
