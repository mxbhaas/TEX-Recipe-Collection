...
\begin{titlepage}
	...
	\vspace{1cm}
	{\Large\itshape Maximilian B. Haas \& Adriana Vitvitchi\par}
	\vfill
...
\section[Moldovian Plăcintă with Cheese Filling]{Moldovian Plăcintă}
\index{Plăcintă}
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
240ml buttermilk\\
240ml milk\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item In a large bowl whisk together 500g of the flour, the baking soda (7.5g), baking powder (4g) and salt (3g). Stir in the egg, buttermilk (240ml), milk (240ml) and 45ml oil until the dough comes together. Gradually knead in the remaining 60g flour until a soft, non-sticky dough forms.
		\item Divide the dough into 8 equal balls (about 140g each). Let rest briefly under a clean cloth.
		\item On a lightly floured surface roll each piece into a 23cm (9") circle. Place approximately 85g of the cheese blend (feta + mozzarella) in the center, fold the edges up and pinch them together at the top. Gently roll or press the sealed parcel again to a flatter 20cm (8") circle.
		\item Pour enough canola oil into a frying pan for shallow frying (approx. 120ml available in the pan), heat over medium-low. Fry each placinta about 2 minutes per side, until golden brown and the cheese is melted. Drain on paper towels and serve warm.
	\end{enumerate}	
\end{minipage}
