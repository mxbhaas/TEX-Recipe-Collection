...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item Either place the dumplings into a steamer, or fry them in a pan with some oil until golden brown. Then add some water to the pan, cover and let them steam for around 5min until cooked through.   
	\end{enumerate}	
\end{minipage}
