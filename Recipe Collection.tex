...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Mix the flour with the salt, and add the boiling water gradually while stirring with a fork. When cool enough, knead the dough on a floured surface until smooth. Cover with a damp cloth and let it rest for 15min.
		\item Chop the cabbage finely, sprinkle with some salt and let it sit for 10min. Then squeeze out the excess water. Finely chop the green onions, garlic and grate the ginger.
		\item In a big bowl, mix the ground pork with the cabbage, green onions, garlic, ginger, soy sauce and sesame oil. Season with salt and pepper.
		\item Roll out the dough into four pieces, give them through a pasta roller to make a thin dough, and cut out 8cm circles to make the wrappers. Add around 1 tbsp of filling in the middle, then fold the dumpling in half and pinch the edges together to seal.
		\item Either place the dumplings into a steamer, or fry them in a pan with some oil until golden brown. Then add 60ml water to the pan, cover and let them steam for around 5min until the water has evaporated.   
	\end{enumerate}	
\end{minipage}

\section{Chicken Wings}
\index{Chicken Wings}
\textit{Source: J. Kenji Lopez-Alt}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
900g chicken wings\\
10g baking powder\\
10g kosher salt\\
...
60ml Frank's RedHot Sauce\\
\end{minipage}
\hfill
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Pat wings very dry. Toss with baking powder, salt and corn starch until evenly coated. Arrange on a rack on a sheet pan with space between wings. Refrigerate uncovered 8-24h.
		\item Preheat oven to 230°. Toss wings with oil, return to sheet/rack and bake 20 min. Flip and bake further 15-30 min, flipping occasionally, until crisp and golden.
		\item Melt butter in a small saucepan over medium; add garlic and cook 1 min until fragrant. Whisk in hot sauce.
		\item Toss wings with sauce to coat, and serve.
	\end{enumerate}	
\end{minipage}
...
\section{Mediterranean Meatballs}
\index{Meatballs}
\textit{Source: The Modern Proper}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
500g mixed ground beef\\
1 small yellow onion, grated, liquid drained\\
3 garlic cloves, minced\\
1 large egg\\
10g minced flat-leaf parsley, plus more for garnish\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Heat the oven to 200°C with a rack in the center position. Line a large sheet pan with parchment paper.
		\item In a large bowl, combine the beef, onion, garlic, eggs, parsley, breadcrumbs, cumin, oregano, cinnamon, salt and pepper. Mix well, then with wet hands, form golf ball–size balls and place them on the prepared sheet pan. You should have about 15 meatballs.
		\item Bake in the oven, rotating the sheet pan halfway through for even baking, until golden brown and cooked through, about 20 minutes. Serve warm.
	\end{enumerate}	
\end{minipage}
...
\section[Sarmale]{Sarmale în foi de varză murată}
\index{Sarmale}
\index{Stuffed Cabbage Rolls}
\textit{Source: Family Recipe}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
1 large cabbage\\
500g rice\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Cut the onions and leek into small cubes. Peel the carrots and finely grate them. Then saute the vegetables with oil in a big pan until soft.
		\item Cut the chicken breast as small as possible, and fry in the same pan with more oil after taking out the vegetable mix.
		\item Take out the middle root of the cabbage with a knife to separate the leaves during cooking. Put it with the root-side up into a big pot with water and start boiling. Properly wash the rice.
		\item Roughly chop the tomatoes and blend them until smooth. To a bowl, add the cooked chicken and vegetables, the chopped parsley, salt and pepper, tomato paste, blended tomatoes and washed rice and mix well.
		\item When soft, take out the cabbage, separate the leaves and cut out the hard root part of each leaf.
		\item In a big cast iron / clay pot, cover the bottom with the cabbage roots, pepper corns and bay leaves. Then take the soft pieces of cabbage, add some filling and roll then rightly. Layer them closely to each other into the pot.
		\item Optional: you can take some of the peppers, fill them with the farce and add them in between the layers for additional taste.
		\item After finishing the layers, add some tomato juice, hot water and then cover with some big cabbage pieces. Cook in the oven at 225°C for 1h 45min, and then leave another hour in the turned-off oven. Service warm with crème fraîche.
	\end{enumerate}	
\end{minipage}
...
\section{Confit Byaldi}
\index{Confit Byaldi}
\index{Ratatouille}
\textit{Source: La Cuisine de Géraldine}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt}
\begin{flushleft}
2 tbsp olive oil\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Heat the olive oil in a frying pan over medium heat. Add the onion and sauté for 5 minutes until translucent. Stir in the garlic and herbes de Provence and cook for 1 more minute.
		\item Add the tomatoes, season with salt and pepper. Simmer for 10 to 15 minutes until the sauce thickens slightly.
		\item Preheat the oven to 160 °C fan. Wash the vegetables and cut them into thin, even slices.
		\item Pour the tomato sauce into a baking dish. Arrange the vegetables in a circle over the sauce and brush with olive oil, herbs, and salt.
		\item Cover the dish with parchment paper or foil and bake for 45 minutes. Remove the paper and bake for another 30 minutes until the vegetables are lightly browned. Serve warm or lukewarm.
	\end{enumerate}	
\end{minipage}
...
\section{Pasta alla Vodka}
\index{Pasta}
\index{Pasta alla Vodka}
\textit{Source: TBD}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt}
200g rigatoni\\
80g prosciutto\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Chop the garlic in thin slices, and the prosciutto in cubes. Give olive oil in a pan, and fry the prosciutto until lightly brown. Then add the garlic slices until fragrant.
...
\section{Pizza Dough}
\index{Pizza Dough}
\textit{Source: Best one found on pizza flour packaging}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
570g typo 00 flour\\
15g sugar\\
9g salt\\
...
\section{Focaccia}
\index{Focaccia}
\textit{Source: YouTube, Food Language}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
\begin{flushleft}
500g typo 00 flour\\
400ml water\\
12g fresh / 6g dry yeast\\
1 tsp sugar\\
2 tbsp olive oil (plus more to grease and drizzle)\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Dissolve yeast and sugar in warm water; add flour to form a soft, no-knead dough, then mix in 2 tbsp olive oil and 2 tsp salt.
		\item Cover and rest 30 min.
		\item Do a stretch-and-fold (wetting hand before each fold), lift-and-slap in the bowl; cover and rest 30 min - repeat the stretch-and-fold + lift-slap once more until dough is bubbly.
		\item Generously oil a baking sheet, transfer dough, drizzle more olive oil and gently spread; cover and rest 30 min, then dimple deeply with oiled fingers, mist with water and sprinkle coarse salt.
		\item Bake at 230°C for 20 minutes.
	\end{enumerate}
\end{minipage}

\section[Pâte Sablée]{Pâte Sablée (for 28cm tarte ring)}
\index{Pâte Sablée}
\index{Tarte}
\textit{Source: Online, La Pâticesse}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Mix the flour and salt, and add the cold butter cubes, until it as a sand-like consistency. Add the egg and mix until a smooth dough. Wrap in plastic wrap and chill in the fridge for at least 1h.
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item Preheat the oven to 170°C. Roll out the Pâte sablée to about 2mm thick on a lightly floured surface, forming a round shape. Line a tart ring or tart pan with the dough, trimming any excess edges. Prick the bottom of the dough with a fork.
...
\section{Tarte aux Groseilles}
\index{Tarte aux Groseilles}
\index{Red Currant Tarte}
\textit{Source: own creation}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
1 recipe pâte sablée\\
350g red currant berries\\
110g sugar\\
3 tbsp cornstarch\\
2 tbsp orange juice
\end{minipage}
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Prepare the dough stick it in the fridge to cool. De-stem and wash the berries, and mix then with the cornstarch in a bowl.
		\item Preheat the oven to 170°C. Roll out the dough and line a 20cm tart pan with it, trimming the edges. Prick the pastry base with a fork and let it freeze entirely.
		\item Heat up the sugar and the orange juice until dissolved. Let it cool, add it in the bowl to the berries and mix well.
		\item Take the tart pan out of the freezer, fill it with the berry mixture and bake for 30-35min until the berries are soft and the pastry is golden brown. Let cool entirely in the fridge before serving. 
		\end{enumerate}
	\end{minipage}
...
\section[Medovic]{Medovic (Honey Cake)}
\index{Medovic}
\textit{Source: Family Recipe}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt}
\textbf{Cake Layers}\\
...
50g butter\\
3 tbsp honey\\
2 tsp baking powder (dissolved in vinegar)\\
650g all-purpose flour\\
1 vanilla bean\\
1.5kg 20\% cream\\
150g powdered sugar\\
1 vanilla bean\\
500g cherries in juice
\end{minipage}
\hfill
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item For the cake layers, beat the eggs with sugar until light and fluffy. Add the the melted butter, honey, and the seeds from half a vanilla bean. Mix well.
		\item Quench the baking powder in a little vinegar and add to the mixture. Gradually add the flour and knead into a smooth dough.
		\item Divide the dough into 6-8 equal parts. Roll each part until thin, and then cut with a plate into a perfect round shape (around 26cm diameter). Bake each layer at 190°C for about 7 minutes until golden.
		\item For the cream, mix the cream with powdered sugar and the seeds from half a vanilla bean until smooth.
		\item To assemble, place the first cake layer on a plate, spread with cream, and add some drained sour cherries. Repeat with all layers, finishing with cream on top and sides. Decorate as desired, and then chill for at least 2h until serving.
	\end{enumerate}
\end{minipage}
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item Using wet hands, roll out small flat balls (roughly 15g each) onto a baking sheet lined with parchment paper. Top each mound with a whole almond and press it in lightly.
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item Carefully pour into the flour mixture, add the egg and mix thoroughly with a dough hook. Transfer the warm dough on a big sheet of cling film on a baking tray, spread out and wrap it entirely. Let it chill for about two hours. Preheat the oven to 175°C shortly before the end of the chilling time.
...
\index{Christmas cookies}
\textit{Source: TBD}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} \raggedright
130g flour (type 405)\\
40g cornstarch\\
30g powdered sugar\\
1 vanilla bean\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		...
		\item In a large bowl, mix the flour, cornstarch, and powdered sugar. Scrape the seeds from the vanilla bean and add them along with the cold butter (in small pieces). Quickly knead everything into a smooth dough. Add the chopped macadamia nuts and knead them in. 
		\item Form balls (12g each) from the dough, flatten them slightly and and place them on the prepared sheet (careful, they spread out quite a bit). Press a small indentation into each cookie with the blunt end of a wooden spoon and then bake for 12 minutes. Remove from the oven, let cool briefly on the sheet, and then transfer to a wire rack to cool completely.
...
\part{Condiments}
\chapter{Sweet}
\section{Pumpkin Apple Jam}
\index{Pumpkin Apple Jam}
\textit{Source: Online, MaltesKitchen}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} \raggedright
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Peel, core the pumpkin and dice into small cubes. Peel the apples, quarter, remove cores and dice to similar size as pumpkin.
		\item Add pumpkin and apples to a pot. Squeeze the lemon and add juice, apple juice, and a pinch of salt. Scrape the vanilla bean seeds and add both seeds and pod to the pot. Cover and cook for approximately 20min until pumpkin is soft.
		\item Remove vanilla pod and purée finely with an immersion blender. Add gelling sugar and cinnamon, stir well and cook according to package instructions (approximately 3min).
		\item Perform a gel test, and if satisfactory, fill into sterilized jars to the brim, close lids and allow to cool.
	\end{enumerate}	
\end{minipage}

\chapter{Savoury}
\section{Cherry Tomato Confit}
\index{Cherry Tomato Confit}
\textit{Own experimentation}\\
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} \raggedright
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Preheat the oven to 120°C. Arrange tomatoes, garlic, basil, and rosemary in a baking dish. Cover generously with olive oil and season with salt.
		\item Bake for 2-3 hours until tomatoes are shriveled and caramelized. Let it cool and store everything in an airtight glass container in the fridge.
	\end{enumerate}	
\end{minipage}
