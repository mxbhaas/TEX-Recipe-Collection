...
\section[Moldovian Plăcintă]{Moldovian Plăcintă with Cheese Filling}
\index{Plăcintă}
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
240ml buttermilk\\
240ml milk\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item In a large bowl whisk together 500g of the flour, the baking soda, baking powder and salt. Stir in the egg, buttermilk, milk and 45ml oil until the dough comes together. Gradually knead in the remaining 60g flour until a soft, non-sticky dough forms.
		\item Divide the dough into 8 equal balls (about 140g each). Let rest briefly under a clean cloth.
		\item On a lightly floured surface roll each piece into a 23cm circle. Place approximately 85g of the cheese in the center, fold the edges up and pinch them together at the top. Gently roll or press the sealed parcel again to a flatter 20cm circle.
		\item Pour enough canola oil into a frying pan for shallow frying, heat over medium-low. Fry each placinta about 2 minutes per side, until golden brown and the cheese is melted. Drain on paper towels and serve warm.
	\end{enumerate}	
\end{minipage}
