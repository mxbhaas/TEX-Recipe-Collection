...
\section{One-pot Spinach Chicken}
\index{Chicken}
\index{One-pot spinach chicken}
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
500g chicken thighs\\
100g baby spinach\\
80g dried tomatoes\\
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Peel and cut the garlic and the tomatoes. Take the lemon zest and chop it finely.
		\item Sear the chicken with oil in the pot until browned and add salt and pepper on each side.
		\item Take out the chicken and set aside. Add a little butter in the pot and fry the garlic until golden. Then de-glaze with stock. Mix the heavy cream with corn starch and add until sauce thickens. Add the chopped dried tomatoes.
		\item Put the chicken back in the pot, add salt, pepper and the lemon zest on top. Braise in the pot with the lid closed for 50min at 160°C in the oven.
		\item Add the spinach, let it fall together in the sauce, and serve with orzo or bread.
	\end{enumerate}	
\end{minipage}
...
\begin{minipage}[t]{0.78\textwidth} \vspace{0pt}
	\begin{enumerate}
		\item Spread flour on surface and form a little mould inside. Add the eggs, the salt and the olive oil in the middle and mix with a fork.
...
\section{Pumpkin Cake}
\index{Pumpkin Cake}
\begin{minipage}[t]{0.21\textwidth} \vspace{0pt} 
200g flour\\
120g cold butter cubes\\
60g sugar\\
40ml ice water\\
\\
2 eggs\\
